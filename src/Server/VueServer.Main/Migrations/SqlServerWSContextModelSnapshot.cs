...
{
    [DbContext(typeof(SqlServerWSContext))]
    partial class SqlServerWSContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("VueServer.Modules.Core.Models.User.WSUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEAtIDa4MJeSOUFEyecm9Rs6KmSgzm/RM2mkoz2AYz//NCflQM5Ee+XXCooDOfZ5Q/Q=="
                        });
                });
