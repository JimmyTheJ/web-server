...
{
    [DbContext(typeof(SqlServerDirectoryContext))]
    [Migration("20220822012139_DirectoryFirst")]
    partial class DirectoryFirst
    {
            ...
            modelBuilder.Entity("VueServer.Modules.Core.Models.User.WSUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEBlg4Jvn5jdL3ZS3c/fqLBABhQGBaqeZHOHw18R9jfHXhTM9EoiUdf+BdPox9w3d2Q=="
                        });
                });
