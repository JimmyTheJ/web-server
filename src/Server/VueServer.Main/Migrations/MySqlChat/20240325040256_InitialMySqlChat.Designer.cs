...
{
    [DbContext(typeof(MySqlChatContext))]
    [Migration("20240325040256_InitialMySqlChat")]
    partial class InitialMySqlChat
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("VueServer.Modules.Core.Models.User.WSUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEMY++2Go63iQrzEG+3KAs8PmMCo1a1u0GXIfDgqi1OP1N0zRw1Q/cOx5KBthKHOM1w=="
                        });
                });
