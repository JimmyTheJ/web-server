...
{
    [DbContext(typeof(SqliteWSContext))]
    partial class SqliteWSContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("VueServer.Modules.Core.Models.User.WSUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEEuUb/LSvhb1dk9rMlyHbmIqjS493GiS5YLTJEWKOrKg/YtkK8HL6U9Cg+3LBL58uQ=="
                        });
                });
