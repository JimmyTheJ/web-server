...
namespace VueServer.Models.Context
{
    public class WSContext : DbContext, IWSContext
    {
        ...
        private void SeedModuleFeatures(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ModuleFeature>().HasData(new ModuleFeature { Id = DomainConstants.Models.ModuleFeatures.Browser.EDIT_ID, Name = DomainConstants.Models.ModuleFeatures.Browser.EDIT_NAME, ModuleAddOnId = DomainConstants.Models.ModuleAddOns.Browser.Id });
