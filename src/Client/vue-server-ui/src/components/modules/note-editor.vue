    ...
    <div class="note-card">
      <div class="nav-bar">
        ...
        <div class="nav-header center">
          <div class="textarea title" contenteditable="true" ref="title"></div>
        </div>
      ...
      <div class="note-inner-container">
        <div class="textarea main" contenteditable="true" ref="note"></div>
        <div class="nav-footer" ref="footer"></div>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    if (this.obj.updated !== '') {
      ...
      if (time !== 'Invalid date') this.$refs.footer.innerText = time
    }
